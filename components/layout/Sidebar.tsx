export default function Sidebar() {
    return (
        <aside className="w-20 bg-white border-r flex flex-col items-center py-6 gap-8">
            {/* Top Navigation Icon */}
            <button className="w-10 h-10 flex items-center justify-center text-blue-500 rounded-full border border-blue-100 hover:bg-blue-50 transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19-7-7 7-7" /><path d="M19 12H5" /></svg>
            </button>

            <nav className="flex flex-col gap-8">
                {/* Shop / Dashboard */}
                <button className="w-12 h-12 flex items-center justify-center text-blue-600 bg-blue-50 rounded-2xl shadow-sm transition-all">
