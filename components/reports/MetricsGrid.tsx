...
export default function MetricsGrid({ metrics }: MetricsGridProps) {
    const displayMetrics = [
        ...
        {
            label: 'Total Omzet',
            value: metrics ? `Rp ${metrics.totalOmzet.toLocaleString('id-ID')}` : 'Rp 0',
        ...
        },
        {
            ...
            value: metrics?.allMenuSales.toString() || '0',
        ...
        {
            label: 'Foods',
            value: metrics?.foodSales.toString() || '0',
            showDetail: true,
        ...
        {
            label: 'Beverages',
            value: metrics?.beverageSales.toString() || '0',
            showDetail: true,
        ...
        {
            label: 'Desserts',
            value: metrics?.dessertSales.toString() || '0',
            showDetail: true,
